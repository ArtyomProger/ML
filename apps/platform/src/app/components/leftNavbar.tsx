            ...
            <div className="leftNavbar_list">
                <Link to={routes.tasks.path}>
                    <div className="leftNavbar_img">
                        <img src={"../assets/navbar_icon_2.png"} alt="" />
                    </div>
                    <p>
                        Задачи и проекты
                    </p>
                ...
                <Link to={routes.customers.path}>
                    <div className="leftNavbar_img">
                        <img src={"../assets/navbar_icon_3.png"} alt="" />
                    </div>
                    <p>
                        Клиенты
                    </p>
                ...
                <Link to={routes.transactions.path}>
                    <div className="leftNavbar_img">
                        <img src={"../assets/navbar_icon_4.png"} alt="" />
                    </div>
                    <p>
                        Транзакции
                    </p>
                ...
                <Link to={routes.connections.path}>
                    <div className="leftNavbar_img">
                        <img src={"../assets/navbar_icon_5.png"} alt="" />
                    </div>
                    <p>
                        Схема связей
                    </p>
                ...
                <Link to={routes.metodology.path}>
                    <div className="leftNavbar_img">
                        <img src={"../assets/navbar_icon_6.png"} alt="" />
                    </div>
                    <p>
