      ...
      <div className="mainScreen_wrapper">
        <div className="mainScreen_text">
          ...
          <div className="mainScreen_list">
            <div>
              <img src={ "./assets/mainScreen_icon_1.png" } alt=""/>
              <p>
                Автоматический анализ транзакций на предмет ОД/ФТ
              </p>
            </div>
            <div>
              <img src={ "./assets/mainScreen_icon_2.png" } alt=""/>
              <p>
                Визуализация связей с контрагентами
              </p>
            </div>
            <div>
              <img src={ "./assets/mainScreen_icon_3.png" } alt=""/>
                <p>
                  Планировщик задач
                </p>
            </div>
        ...
        <div className="mainScreen_img">
          <img src={"./assets/mainScreen_pc.png"} alt=""/>
        </div>
      </div>
    );
};